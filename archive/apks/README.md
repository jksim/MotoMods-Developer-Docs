...
Files are in `docs/assets/apks/` and served with the site; the example
pages link to them. Per-file package, version, size, SHA-256, signer and
published URL: `index.json`. Re-check with
