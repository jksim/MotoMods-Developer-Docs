...
surviving listing exists to check one against. The one check that would carry
weight is the APK's signing certificate, which cannot be forged: an APK signed
by Motorola's key is almost certainly the original.
